...
int main(int argc, void *argv[]){
	...
	gwTexture *tex2 = new gwTexture("./shiplow.png");
	
	obj->bindTexture(tex2);
	obj->bindTexture(tex);

	
	gwTimer *timer = new gwTimer();
	timer->newEvent(1.f/30.f, renderFrame, render);//render @ 30fps
	timer->newEvent(1.f/60.f, updateFrame, timer);//update logic @ 60fps
