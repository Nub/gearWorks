...
enum gwGuState {//GU state clones
	GW_ALPHA_TEST,
	GW_DEPTH_TEST,
	GW_SCISSOR_TEST,
	GW_STENCIL_TEST,
	...
	GW_COLOR_TEST,
	GW_COLOR_LOGIC_OP,
	GW_FACE_NORMAL_REVERSE,
	GW_PATCH_FACE,
	GW_FRAGMENT_2X,
	GW_TRIPLE_BUFFER// custom support ;)
};
...
typedef struct _gwMatrix
{
	gwVector4 x,y,z,w;
}gwMatrix4 __attribute__((aligned(16)));
